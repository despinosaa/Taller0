...
public class ConsolaOlimpicos
{
	...
	/**
	 * Ejecuta la opci�n para consultar el pa�s que representa un atleta dado.
	 */
	private void ejecutarPaisAtleta()
	{
		String nombreAtleta = input("Ingrese el nombre del atleta que desea consultar");
		String paisAtleta = calculadora.paisAtleta(nombreAtleta);
		System.out.println("\n" + "El atleta " + nombreAtleta + " representa al pa�s " + paisAtleta + ".");
	}
